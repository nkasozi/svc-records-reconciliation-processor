...
pub struct FileChunkReconciliationService<'a> {
    pub pubsub_repo: &'a dyn PubSubRepositoryInterface,
    pub file_reconciliation_algorithm: &'a dyn FileReconciliationAlgorithmInterface,
}

#[async_trait]
impl FileChunkReconciliationServiceInterface for FileChunkReconciliationService<'_> {
    /**
    ...
    */
    async fn reconcile_file_chunk<'a>(
        &'a self,
        reconcile_primary_file_chunk_request: &'a ReconcileFileChunkRequest,
...
impl FileChunkReconciliationService<'_> {
